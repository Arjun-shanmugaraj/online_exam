                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                  <form action="{{route('qustabupdate',$ins->qusid)}}" method="POST">
                                        {{csrf_field()}}
                                        <div class="form-group">
                                            <label>Exam Id</label>
                                            <input type="text" class="form-control" readonly name="eid" id="eid" value="{{$ins->eid}}">
                                        </div>
                                    <div class="form-group">
                                            <label>Qustion id</label>
                                            <input type="text" class="form-control" name="qusid" readonly id="qusid" value="{{$ins->qusid}}">
                                        </div>
                                        <div class="form-group">
                                            <label>Questions </label>
                                            <input type="text" class="form-control" name="question" id="question" value="{{$ins->question}}">
                                        </div>
                                        <div class="form-group">
                                            <label>Option 1</label>
                                            <input type="text" class="form-control" name="op1" id="op1" value="{{$ins->op1}}">
                                        </div>
                                        <div class="form-group">
                                            <label>Option 2</label>
                                            <input type="text" class="form-control" name="op2" id="op2" value="{{$ins->op2}}">
                                        </div>
                                        <div class="form-group">
                                            <label>Option 3</label>
                                            <input type="text" class="form-control" name="op3" id="op3" value="{{$ins->op3}}">
                                        </div>
                                        <div class="form-group">
                                            <label>Option 4</label>
                                            <input type="text" class="form-control" name="op4" id="op4" value="{{$ins->op4}}">
                                        </div>
                                        <div class="form-group">
                                            <label>Answer</label>
                                            <input type="text" class="form-control" name="ans" id="ans" value="{{$ins->ans}}">
                                        </div>   
