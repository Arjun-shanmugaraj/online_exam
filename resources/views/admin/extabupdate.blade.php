                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="{{route('extabupdate',$ins->eid)}}" method="POST">
                                        {{csrf_field()}}
                                        <div class="form-group">
                                            <label>Exam Id</label>
                                            <input type="text" class="form-control" name="eid" id="eid" readonly value="{{$ins->eid}}">
                                        </div>
                                        <div class="form-group">
                                            <label>Exam Name</label>
                                            <input type="text" class="form-control" name="ename" id="ename" value="{{$ins->ename}}">
                                        </div>
                                        <div class="form-group">
                                            <label>Time</label>
                                            <input type="text"  class="form-control" name="time" id="time" value="{{$ins->time}}">
                                        </div>
                                        <div class="form-group">
                                            <label>Total</label>
                                            <input type="text" class="form-control" name="total" id="total" value="{{$ins->total}}">
                                        </div>
                                        <div class="form-group">
                                            <label>Mark(each questions)</label>
                                            <input type="text" class="form-control" name="mark" id="mark" value="{{$ins->mark}}">
                                        </div>
