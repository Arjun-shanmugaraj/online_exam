    ...
    <!--END MAIN WRAPPER -->
        ...
        <div id="content">
                ...
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Exam's Table</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                                    ...
                                    <table style="width: 100%;" class="table">
                                        <thead>
                                            ...
                                            <tbody>
                                                @foreach($tab as $arj)
                                                <tr>
                                                <td><a href="{{route('extabup',$arj->eid)}}">{{$arj->eid}}</a></td>
                                                <td>{{$arj->ename}}</td>
                                                <td>{{$arj->time}}</td>
                                                <td>{{$arj->total}}</td>
                                                <td>{{$arj->mark}}</td>
                                                <td><a href="{{route('qustab',$arj->eid)}}"><button class="btn btn-default">VIEW</button></a></td>
                                            </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
